    ...
    <div class="main-area">
      ...
      <main class="content">
        <div class="placeholder-container">
          ...
          <h2 class="placeholder-title">Upload Your Voice</h2>
          <p class="placeholder-desc">Record or upload audio samples to clone your voice for story narration</p>
          <div class="placeholder-features">
            ...
            <div class="feature-item">
              <span class="feature-check">*</span>
              <span>Support MP3, WAV formats</span>
            </div>
            <div class="feature-item">
              <span class="feature-check">*</span>
              <span>Create personalized narration</span>
            </div>
          </div>
